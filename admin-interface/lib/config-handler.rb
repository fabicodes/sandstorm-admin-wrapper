...
MUTATORS = {
  ...
  'DesertEaglesOnly' => { 'name' => 'Desert Eagles Only', 'description' => 'Only Desert Eagle pistols are available along with normal equipment and explosives.' },
  ...
  'GrenadeLaunchersOnly' => { 'name' => 'Grenade Launchers Only', 'description' => 'Only Grenade Launchers are available.' },
  'Guerrillas' => { 'name' => 'Guerrillas', 'description' => 'Start with 5 supply points.' },
  'Gunslingers' => { 'name' => 'Gunslingers', 'description' => 'Kill the enemy more than they kill you with a big stinkin\' revolver. And explosives.' },
  ...
  'MakarovsOnly' => { 'name' => 'Makarovs Only', 'description' => 'Makarovs are the only option.' },
  'NoAim' => { 'name' => 'No Aim Down Sights', 'description' => 'Aiming down sights is disabled.' },
  'NoDeathCam' => { 'name' => 'No Death Camera', 'description' => 'Forces the death camera to be disabled for all players.' },
  'NoDrops' => { 'name' => 'No Drops', 'description' => 'No scavenging allowed.' },
  'NoThirdPerson' => { 'name' => 'No Third Person', 'description' => 'The third person camera for spectator mode is disabled.' },
  'OfficialRules' => { 'name' => 'Official Rules', 'description' => 'All gamemodes are forced to default rules.' },
  'PistolsOnly' => { 'name' => 'Pistols Only', 'description' => 'Only pistols are available along with normal equipment and explosives.' },
  'Poor' => { 'name' => 'Poor', 'description' => 'Start with limited supply.' },
  ...
  'SmallFirefight' => { 'name' => 'Small Firefight', 'description' => 'Adjusts Firefight to suit a smaller player count by adjusting round count, round timer, and capture times.' },
  ...
  'TacticalVoiceChat' => { 'name' => 'Tactical Voice Chat', 'description' => 'Allows dead players to speak to the living, disables proximity chat to the enemy.' },
  'TieBreaker' => { 'name' => 'Tie Breaker', 'description' => 'In Firefight, enable overtime and replaying rounds in the event of a draw.' },
  ...
  'Welrods' => { 'name' => 'WELRODS!', 'description' => 'Every player is forced to use the bolt-action Welrod pistol.' },
  'WelrodsOnly' => { 'name' => 'Welrods Only', 'description' => 'Only bolt-action Welrod pistols are available along with normal equipment and explosives.' }
}
